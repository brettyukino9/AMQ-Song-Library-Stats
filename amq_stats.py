...
if not percentage_method: #default
    ...
    above_80 = len(data_list[data_list['recent percentage'] >= 70])
...
print(f'Learned entries (>80%): {above_80} / {total_entries} {above_80 / total_entries * 100}%')
print(f'Unlearned entries (<80%): {unlearned} / {total_entries} {unlearned / total_entries * 100}%')
print(f'Unplayed entries: {unplayed} / {total_entries} {unplayed / total_entries * 100}%')
print("--------------------")
# OP / ED / IN Stats
...
print(f"Openings learned %: {len(openings[openings['percentage'] >= 80])} / {len(openings)} ", len(openings[openings['percentage'] >= 80]) / len(openings) * 100)
...
print(f"Openings under 30 openings learned %: {len(op_under_30[op_under_30['percentage'] >= 80])} / {len(op_under_30)}", len(op_under_30[op_under_30['percentage'] >= 80]) / len(op_under_30) * 100)
print("Openings under 30 openings unlearned %: ", len(op_under_30[(op_under_30['percentage'] < 80) & (op_under_30['plays'] > 0)]) / len(op_under_30) * 100)
print("Openings under 30 openings unplayed %: ", len(op_under_30[op_under_30['plays'] == 0]) / len(op_under_30) * 100)
print("--------------------")
...
print(f"Endings learned {len(endings[endings['percentage'] >= 80])} / {len(endings)} %: ", len(endings[endings['percentage'] >= 80]) / len(endings) * 100)
...
print(f"Endings under 30 endings learned %: {len(end_under_30[end_under_30['percentage'] >= 80])} / {len(end_under_30)}", len(end_under_30[end_under_30['percentage'] >= 80]) / len(end_under_30) * 100)
print("Endings under 30 endings unlearned %: ", len(end_under_30[(end_under_30['percentage'] < 80) & (end_under_30['plays'] > 0)]) / len(end_under_30) * 100)
print("Endings under 30 endings unplayed %: ", len(end_under_30[end_under_30['plays'] == 0]) / len(end_under_30) * 100)
print("--------------------")
...
print(f"Inserts learned %: {len(inserts[inserts['percentage'] >= 80])} / {len(inserts)} ", len(inserts[inserts['percentage'] >= 80]) / len(inserts) * 100)
...
print(f"Inserts under 30 inserts learned %: {len(in_under_30[in_under_30['percentage'] >= 80])} / {len(in_under_30)}", len(in_under_30[in_under_30['percentage'] >= 80]) / len(in_under_30) * 100)
print("Inserts under 30 inserts unlearned %: ", len(in_under_30[(in_under_30['percentage'] < 80) & (in_under_30['plays'] > 0)]) / len(in_under_30) * 100)
print("Inserts under 30 inserts unplayed %: ", len(in_under_30[in_under_30['plays'] == 0]) / len(in_under_30) * 100)
print("--------------------")
...
print(f"under 30 songs learned %: {len(under_30_songs[under_30_songs['percentage'] >= 80])} / {len(under_30_songs)}", len(under_30_songs[under_30_songs['percentage'] >= 80]) / len(under_30_songs) * 100)
